package com.mengqingdi.zip4jGeneral.exception;
...
public class ZipException extends Exception {
    ...
    public ZipException(String message, Throwable cause) { super(message, cause); }
    ...
    public ZipException(Throwable cause) { super(cause); }
