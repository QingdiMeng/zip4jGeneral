...
public class ZipModel implements Cloneable {
    ...
    public ZipModel() { splitLength  = -1; }

    public Map<String, byte[]> getRawStore() {
        return rawStore;
    }

    public void setRawStore(Map<String, byte[]> rawStore) {
    ...
    public void setZip64Format(boolean zip64Format) {
        isZip64Format = zip64Format;
    }
    ...
    public void setNestedZipFile(boolean nestedZipFile) {
        isNestedZipFile = nestedZipFile;
    }
